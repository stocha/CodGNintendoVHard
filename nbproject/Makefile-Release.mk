...
${OBJECTDIR}/BitLogicNintendo.o: BitLogicNintendo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BitLogicNintendo.o BitLogicNintendo.cpp
...
${OBJECTDIR}/Normaliser.o: Normaliser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Normaliser.o Normaliser.cpp
...
${OBJECTDIR}/BitLogicNintendo_nomain.o: ${OBJECTDIR}/BitLogicNintendo.o BitLogicNintendo.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BitLogicNintendo_nomain.o BitLogicNintendo.cpp;\
	else  \
...
${OBJECTDIR}/BitLogicNintendo2_nomain.o: ${OBJECTDIR}/BitLogicNintendo2.o BitLogicNintendo2.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BitLogicNintendo2_nomain.o BitLogicNintendo2.cpp;\
	else  \
...
${OBJECTDIR}/FirstTry_nomain.o: ${OBJECTDIR}/FirstTry.o FirstTry.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FirstTry_nomain.o FirstTry.cpp;\
	else  \
...
${OBJECTDIR}/Normaliser_nomain.o: ${OBJECTDIR}/Normaliser.o Normaliser.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Normaliser_nomain.o Normaliser.cpp;\
	else  \
...
${OBJECTDIR}/OfficialEncoder_nomain.o: ${OBJECTDIR}/OfficialEncoder.o OfficialEncoder.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OfficialEncoder_nomain.o OfficialEncoder.cpp;\
	else  \
...
${OBJECTDIR}/v5_Formulaz_nomain.o: ${OBJECTDIR}/v5_Formulaz.o v5_Formulaz.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/v5_Formulaz_nomain.o v5_Formulaz.cpp;\
	else  \
...
${OBJECTDIR}/v5_main_nomain.o: ${OBJECTDIR}/v5_main.o v5_main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/v5_main_nomain.o v5_main.cpp;\
	else  \
